...
const (
	...
	BASERR_TOKEN_PENDING          EnumBasErr = BasErrBegin + 207 //访问令牌状态未确认。    同上
	...
	BASERR_BASNOTIFY_Aliyun_Intl_ERR                   EnumBasErr = BasMoreErrBegin + 61
...
var EnumBasErr_desc = map[EnumBasErr]string{
	...
	BASERR_TOKEN_PENDING:          "TokenPending",
	...
	BASERR_BASNOTIFY_Aliyun_Intl_ERR:             "BasNotifyAliyunIntlErr",
